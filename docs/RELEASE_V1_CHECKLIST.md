# Чек-лист release-сборки v1.0+ (устарел)

> **Статус: устарел для линии 2.0.0.**
> Актуальный чек-лист: [`docs/RELEASE_V2_CHECKLIST.md`](RELEASE_V2_CHECKLIST.md).
> Этот файл сохранён как исторический документ приёмки линейки 1.x и **не** должен использоваться для выпуска Mars 2.0.0.
